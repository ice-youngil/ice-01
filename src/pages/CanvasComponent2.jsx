...
const CanvasComponent2 = forwardRef(({
  ...
  useImperativeHandle(ref, () => ({
    ...
    addEmoji: (element) => {
      if (canvas) {
        console.log("emoji add");
        fabric.Image.fromURL("https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f34a.png", (img) => {
          canvas.add(img);
          canvas.renderAll();
          saveHistory();
        });
  ...
  return (
    <div className="canvas-container">
      ...
      <button onClick={abcd}>adfsdfasdfasdf</button>
    </div>
  );
});
